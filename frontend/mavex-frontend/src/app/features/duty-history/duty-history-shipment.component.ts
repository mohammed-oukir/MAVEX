...
@Component({
  selector: 'app-duty-history-shipment',
  imports: [RouterLink, DatePipe],
  templateUrl: './duty-history-shipment.component.html',
  styleUrl: './duty-history-shipment.component.css',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class DutyHistoryShipmentComponent implements OnInit {
  ...
  hasFilters = computed(() =>
    !!this.flChangedByName() || !!this.flFrom() || !!this.flTo()
  );

  totalPages = computed(() => Math.ceil(this.total() / this.pageSize()));

  ngOnInit(): void {
    this.layout.setPage('Historique Duty — Shipment');
  ...
  private loadHistory(): void {
    ...
    this.shipSvc.getShipmentDutyHistory(
      this.shipmentId(),
      {
